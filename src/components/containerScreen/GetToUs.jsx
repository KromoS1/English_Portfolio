        ...
        <>
            <section id={'library'} className={style.section}>
                <div className={style.container}>
                    <Record title={'Заполните форму, чтобы попасть на бесплатное пробное занятие'}/>
                    <Separated/>
                    ...
                    <div className={style.rowStage}>
                        ...
                        />
                        <QuestionAnswer question={'Как производится оплата?'}
                        ...
                        />
                        <QuestionAnswer question={'Сколько длится курс?'}
                        ...
                        <QuestionAnswer question={'Есть ли пробное занятие?'}
                                        answer={'Да. На пробном занятии мы определим Ваш уровень языка, цели обучения и тип восприятия, а также вы познакомитесь с преподавателем.'}
                        />
                    </div>
                </div>
            </section>
            <section className={style.section}>
                <div className={style.container}>
                    ...
                    <div className={style.rowStage}>
                        ...
                        <GetToUsBlock iconName={'money-check'} text={'3. Оплата'}/>
